...
public class AttackCalculator : MonoBehaviour
{
    ...
    public void CalculateAttackLines(SpinTypeNames _spinType, int _lineClearCount)
    {
        ...
        attackCalculatorStats = attackCalculatorStats.Update(_attackLines: attackCalculatorStats.AttackLines + spinTypeAttackMapping[_spinType][_lineClearCount]);
    ...
    private void CalculateBackToBack(SpinTypeNames _spinType, int _lineClearCount)
    {
        ...
        {
            attackCalculatorStats = attackCalculatorStats.Update(_backToBack: true);
        }
        else
        {
            if (_lineClearCount >= 1)
            {
                attackCalculatorStats = attackCalculatorStats.Update(_backToBack: false);
            }
        }
    }
    ...
    private void CalculatePerfectClear()
    {
        ...
        {
            attackCalculatorStats = attackCalculatorStats.Update(_perfectClear: false);
        }
    }
